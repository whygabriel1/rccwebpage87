  ...
  return (
    <div className="pt-16">
      ...
      <section className="relative min-h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 container mx-auto px-4 py-20 md:py-10 flex items-center justify-center md:items-start md:justify-start min-h-screen">
          <div className="w-full max-w-xl md:ml-0 ml-auto mr-auto flex flex-col items-center md:items-start px-2 md:px-0 mt-8 md:mt-32">
            <h1 className="text-4xl md:text-6xl font-extrabold text-white leading-tight mb-2 md:mb-4 text-center md:text-left">
              Unidad Educativa
            </h1>
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-2 md:mb-4 text-center md:text-left">
              Roberto Castillo
            </h2>
            <h3 className="text-3xl md:text-5xl font-bold text-white mb-4 md:mb-8 text-center md:text-left">
              Cardier
            </h3>
            <p className="text-lg md:text-2xl text-white opacity-90 mb-8 md:mb-12 text-center md:text-left">
      ...
      <div className="relative z-10 bg-blue-600 text-white py-16">
      ...
      {/* Statistics */}
      <div className="relative z-10 bg-white py-16" ref={statsRef}>
        <div className="container mx-auto px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <p className="text-gray-600">
                    <strong>Ingresar al Sistema Académico</strong>
                  </p>
                </div>
                <div className="text-right">
                  <p className="text-gray-600">
                    <strong>Ingresar al Modo Administrador</strong>
                  </p>
                </div>
              </div>
