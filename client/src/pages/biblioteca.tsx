          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            {books.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {books.map((book) => (
                  <Card key={book.id} className="hover:shadow-md transition-shadow flex flex-col h-full">
                    ...
                    <CardContent className="p-6 flex flex-col flex-1">
                      <div className="mb-2 min-h-[80px] flex flex-col justify-between">
                        ...
                        <span className="text-gray-600 line-clamp-1">{book.autor}</span>
                      </div>
                      ...
                      <div className="flex space-x-2 mt-4">
                        ...
                        <Button
                          ...
                          asChild
                        >
                          <a href={book.pdf || '#'} download target="_blank" rel="noopener noreferrer">
